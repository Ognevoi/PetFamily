...
public class GetPetPhotosHandler(
    ...
    : ICommandHandler<IEnumerable<string>, GetPetPhotosCommand>
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var getResult = await filesProvider.GetFileLink(
            photosToGet,
            Constants.BUCKET_NAME,
            cancellationToken);

        logger.LogInformation("Photos for pet with id {PetId} retrieved", command.PetId);
